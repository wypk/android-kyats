...
import wyp.kyats.domain.otherbanks.stringparser.CommonStringParser;
import wyp.kyats.domain.otherbanks.webpageparser.AYAExchangeRateParser;
import wyp.kyats.foundation.SharedPreferencesConstants;
import wyp.kyats.ui.adapter.OthersBankExchangeRateRVAdapter;

public class AYABankExchangeRateFragment extends OtherBanksExchangeRateBaseFragment {

    @Override
    public void getLatestExchangeRate() {

        new AYAExchangeRateParser(new AYAExchangeRateParser.ParserResponse() {
            ...
            public void onSuccess(@NonNull ExchangeRateResponseModel exchangeRateResponseModel) {
                ...
                if (exchangeRateResponseModel.updatedDate != null) {
                    ...
                    OtherBanksExchangeRatesManipulator
                            .save(SharedPreferencesConstants.RATE_AYA_BANK_PREFERENCES_NAME,
    ...
    public void showOnUI() {
        ...
        ExchangeRateResponseModel exchangeRateResponseModel = OtherBanksExchangeRatesManipulator
                .retrieve(SharedPreferencesConstants.RATE_AYA_BANK_PREFERENCES_NAME);
        ...
        if (exchangeRateResponseModel != null) {
            ...
            for (String rawRate : rawRates) {
                ...
                ExchangeRateModel exchangeRateModel = CommonStringParser.parse(rawRate);
